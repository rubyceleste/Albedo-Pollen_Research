...
library(reshape2)
#binding all the snow data together, only binding value columns, coordinates are in jan df
dat_all = data.frame(snow_jan=df1, snow_feb=df2$snow_feb, snow_march=df3$snow_march, 
                     snow_april=df4$snow_april, snow_may=df5$snow_may, snow_june=df6$snow_june,
                     snow_july=df7$snow_july, snow_aug=df8$snow_aug, snow_sept=df9snow_sept,
                     snow_oct=df10$snow_oct, snow_nov=df11$snow_nov, snow_dec=df12$snow_dec,
