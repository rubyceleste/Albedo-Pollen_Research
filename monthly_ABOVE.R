...
resamp_jan = readRDS('data/albedo_january.RDS')
resamp_feb = readRDS('data/albedo_february.RDS')
resamp_march = readRDS('data/albedo_march.RDS')
resamp_april = readRDS('data/albedo_april.RDS')
resamp_may = readRDS('data/albedo_may.RDS')
resamp_june = readRDS('data/albedo_june.RDS')
resamp_july = readRDS('data/albedo_july.RDS')
resamp_aug = readRDS('data/albedo_august.RDS')
resamp_sept = readRDS('data/albedo_september.RDS')
resamp_oct = readRDS('data/albedo_october.RDS')
resamp_nov = readRDS('data/albedo_november.RDS')
resamp_dec = readRDS('data/albedo_december.RDS')
